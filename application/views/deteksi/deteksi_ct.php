            ...
            <div class="col">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb justify-content-center bg-transparent p-0 m-0">
                        ...
                        <li class="breadcrumb-item active text-primary">CT-Scan</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <section>
        <div class="container">
            <div class="row justify-content-center text-center">
                <div class="col-lg-8">
                    <div class="mb-5">
                        <h2 class="mb-0"><span class="font-w-4 d-block">Silakan upload hasil CT-Scan anda</span></h2>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-6">
                    <!-- Load the model -->
                    <input type="hidden" id="base" value="<?php echo base_url("assets/"); ?>model/ct/model.json">
